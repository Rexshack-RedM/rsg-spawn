...
RegisterNetEvent('rsg-spawn:client:newplayer', function()
    ...
    DoScreenFadeOut(1000)
    SetEntityCoords(PlayerPedId(), Config.SpawnLocation.coords.x, Config.SpawnLocation.coords.y, Config.SpawnLocation.coords.z)
    SetEntityHeading(PlayerPedId(), Config.SpawnLocation.coords.w)
    FreezeEntityPosition(PlayerPedId(), false)
    TriggerServerEvent('RSGCore:Server:OnPlayerLoaded')
    TriggerEvent('RSGCore:Client:OnPlayerLoaded')
    FreezeEntityPosition(ped, false)
